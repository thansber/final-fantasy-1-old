...
function(Map, MapConstants) {
  ...
  var tiles = {
      ...
      "CL": {y:3, x:15, desc:"crescent lake"},
      "CO": {y:2, x:13, desc:"coneria town"},
      "D1": {y:4, x:13, desc:"docks upper left"},
      "D2": {y:4, x:14, desc:"docks upper middle"},
      "D3": {y:4, x:15, desc:"docks upper right"},
      "D4": {y:5, x:13, desc:"docks lower left"},
      "D5": {y:5, x:15, desc:"docks lower right"},
      "EL": {y:3, x:13, desc:"elfland"},
      ...
      "ML": {y:3, x:14, desc:"melmond"},
      "O" : {y:5, x:1, desc:"hole"},
      "ON": {y:3, x:14, desc:"onrac"},
      "PR": {y:2, x:13, desc:"pravoka"},
      ...
      "V1": {y:2, x:16, desc:"gurgu volcano upper left"},
      "V2": {y:2, x:17, desc:"gurgu volcano upper right"},
      "V3": {y:3, x:16, desc:"gurgu volcano lower left"},
      "V4": {y:3, x:17, desc:"gurgu volcano lower right"},
      "WF": {y:5, x:14, desc:"waterfalls"},
      "^-": {y:2, x:10, desc:"coneria castle upper left"},
      "-^": {y:2, x:11, desc:"coneria castle upper right"},
      "[-": {y:3, x:10, desc:"coneria castle middle left"},
      "-]": {y:3, x:11, desc:"coneria castle middle right"},
      "[_": {y:4, x:10, desc:"coneria castle lower left"},
      "_]": {y:4, x:11, desc:"coneria castle lower right"},
      ...
      "/,": {y:3, x:9, desc:"wall middle lower left"},
      ",/": {y:3, x:12, desc:"wall middle lower right"},
      "/:": {y:4, x:9, desc:"wall lower left"},
      ":/": {y:4, x:12, desc:"wall lower right"},
