...
function(MapConfig, MapCoordsAbsolute, MapTile, MapConstants, MovementConstants) {
  ...
  var init = function() {
    ...
    MapConfig.create({id:MapConstants.SARDAS_CAVE, numTilesets:1, height:17, width:27, 
                      start:MapCoordsAbsolute.create({y:28, x:14}), hasBattles:false})
              .setMapping($.extend({}, mapping, {
                "A" : MapTile.create({cssClasses:"bed top"}),
                "B" : MapTile.create({cssClasses:"bed bottom"}),
                "%" : MapTile.create({cssClasses:"fireplace"})
               }))
              .addTileset(["JKKKKLKKKKL        JKKKKKKL",
                           "Mr%rBNrrrpN        MrprprpN",
                           "MrrrANrrCrN        MrrppppN",
                           "MrrrrNrrTrN        OPPPPPPQ",
                           "MrrrTNrrrrNWWWWWWWWWDWYWWWW",
                           "MrrrrrrrrrN...........X    ",
                           "MrrrrNPPPrQ...........X    ",
                           "OPPPPQWWJrL.XWWUWWWW..X    ",
                           "UWWWWW..MrN.X  V......X    ",
                           "V.......OPQ.X  V......X    ",
                           "V.......WDW.X  V..WWWWY    ",
                           "V...........X  V......X    ",
                           "WWWWWWWWWWWWW  V.UWY..X    ",
                           "               V.V>X..X    ",
                           "               V.W.W..X    ",
                           "               V......X    ",
                           "               WWWWWWWW    "]);
