var TownMaps = (function() {
  ...
  self.Coneria = (function() {
    this.Config = new Map.Config({id:Map.CONERIA, numTilesets:1, tilesPerArea:34, hasBattles:false});
    // 35x26
  ...
  self.Pravoka = (function() {
    this.Config = new Map.Config({id:Map.PRAVOKA, numTilesets:1, tilesPerArea:41, hasBattles:false});
    // 38x34
    this.Config.addTileset([
      "                                                 "
  ...
  self.Elfland = (function() {
   this.Config = new Map.Config({id:Map.ELFLAND, numTilesets:1, tilesPerArea:44, hasBattles:false});
   // 44x44
    this.Config.addTileset([
      "                                                    "
  ...
  self.Melmond = (function() {
   this.Config = new Map.Config({id:Map.MELMOND, numTilesets:1, tilesPerArea:40, hasBattles:false});
   // 40x35
   this.Config.addTileset([
     "                                      s   "
  ...
  self.CrescentLake = (function() {
    this.Config = new Map.Config({id:Map.CRESCENT_LAKE, numTilesets:1, tilesPerArea:49, hasBattles:false});
    // 48x25
    this.Config.addTileset([
  ...
  self.Onrac = (function() {
   this.Config = new Map.Config({id:Map.ONRAC, numTilesets:1, tilesPerArea:52, hasBattles:false});
   // 52x38
   this.Config.addTileset([
  ...
  self.Gaia = (function() {
   this.Config = new Map.Config({id:Map.GAIA, numTilesets:1, tilesPerArea:58, hasBattles:false});
    // 55x58
    this.Config.addTileset([
  ...
  self.Lefein = (function() {
   this.Config = new Map.Config({id:Map.LEFEIN, numTilesets:1, tilesPerArea:58, hasBattles:false});
    // 
    this.Config.addTileset([
      "                                                                   "
     ,"                                                          t        "                      
