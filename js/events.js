...
function($, Logger) {
  ...
  var animations = {
   ...
   ,MessageTogglerDone : "animationMessageTogglerDone"
   ,MoveChar : "animationMoveChar"
   ,MoveCharDone : "animationMoveCharDone"
   ,MoveCharForCommand : "animationMoveCharForCommand"
   ,MoveCharForCommandDone : "animationMoveCharForCommandDone"
   ...
   ,Rewards : "animationRewards"
   ,RewardsDone : "animationRewardsDone"
